...
def thread_proc():
    global Yokogawa_V, pw, f_exit, currValues, voltValues, voltValuesGate, curr_curr
    ...
    for i, curr_VG in enumerate(voltValuesGate):
        ...
        def PerformStep(yok, currValues, voltValues,
            ...
            if volt > upper_R_bound:
                ...
                lastResistance = UpdateResistance(pw.Axes[tabIV], np.array(this_RIValues) * k_A, np.array(this_RUValues) * k_V_meas)

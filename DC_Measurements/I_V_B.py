...
def DataSave():
    ...
    shell.SaveMatrix(fieldValues, currValues, voltValues, f'I, {shell.I_units}A', caption=caption)
    shell.SaveData({'B, G': fieldValues_axis[:len(resistanceValues)], 'R, Ohm': resistanceValues}, caption + '_R')

...
try:
    ...
    swept_range = np.arange(range_start, range_stop, range_step)
generator_id = 'TCPIP0::10.20.61.199::inst0::INSTR'
...
def UpdateRealtimeThermometer():
    ...
    T_curr = iv_swe''eper.lakeshore.GetTemperature()
    times.append(t)
    t += 1
    ...
    for i, swept_now in enumerate(KeysightGenerator):
        ...
        def PerformStep(yok, currValues, fieldValues, voltValues,
            ...
            if volt > upper_R_bound:
                ...
                if pw.CurrentTab == 1:
                    UpdateResistance(pw.Axes[tabIV], np.array(this_RIValues) * k_A, np.array(this_RUValues) * k_V_meas)

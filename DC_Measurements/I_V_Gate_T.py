...
Yokogawa_V = DebugYokogawaMeasurer(device_num=yok_write, dev_range='1E+1', what='VOLT')
# ------------------------------------------------------------------------------------------------------------
...
try:
    gate_amplitude, gate_points, temp0, tempRange, tempStep = [float(i) for i in user_params.split(';')]
    if temp0 == 0:
...
LakeShore = DebugLakeShoreController(mode='active', device_num=ls, temp0=temp0, max_temp=tempRange, tempStep=tempStep)
